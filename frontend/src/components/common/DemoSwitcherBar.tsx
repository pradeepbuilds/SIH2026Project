...
import { UserCheck, GraduationCap, Building2, Briefcase, Wrench, Sparkles } from 'lucide-react';
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          {demoPresets.map((preset) => {
            ...
            return (
              <button
                key={preset.email}
                onClick={() => loginWithDemoAccount(preset.email)}
